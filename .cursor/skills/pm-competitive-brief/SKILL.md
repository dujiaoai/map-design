...
description: >-
  Build competitive analysis briefs for map-design and geospatial SaaS context. Use when the user asks for 竞品分析, feature comparison matrix, positioning, win/loss, or strategic implications versus map/GIS or field-ops products.
license: Apache-2.0
---
...
```
/pm-competitive-brief $ARGUMENTS
```
