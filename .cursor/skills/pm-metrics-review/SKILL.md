...
description: >-
  Review product metrics and OKRs for map-design. Use when the user asks for 指标复盘, North Star, funnel analysis, dashboard requirements, experiment readouts, or goal setting for workspace adoption, auth, or plugin usage.
license: Apache-2.0
---
