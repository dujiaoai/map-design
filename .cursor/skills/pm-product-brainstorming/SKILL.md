---
name: pm-product-brainstorming
description: >-
  Brainstorm product ideas for map-design with PM frameworks (JTBD, HMW, opportunity trees). Use when the user wants 头脑风暴, problem exploration, assumption testing, strategy sparring, or early ideation before writing a PRD for the map workspace.
license: Apache-2.0
---
