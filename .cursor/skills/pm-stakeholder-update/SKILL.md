...
description: >-
  Draft stakeholder updates for map-design product work. Use when the user needs 周报, 月报, executive summary, engineering sync, launch comms, ROAM risks, or ADRs for SaaS map workspace initiatives—tailored to exec, engineering, or customer audiences.
license: Apache-2.0
---
...
If team chat context is available:
...
If meeting notes are available:
