...
description: >-
  Synthesize user research for map-design. Use when the user provides interview notes, survey data, support themes, or asks for 用户研究, persona, affinity mapping, thematic analysis, or opportunity sizing for the map workspace or tenant users.
license: Apache-2.0
---
