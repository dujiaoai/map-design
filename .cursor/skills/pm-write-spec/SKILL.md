...
name: pm-write-spec
description: >-
  Write feature specs and PRDs for map-design SaaS (map workspace, RuoYi auth, three-app monorepo). Use this skill whenever the user asks for PRD, 需求文档, 功能规格, user stories, acceptance criteria, MoSCoW scope, or turns a vague feature idea into a structured spec for apps/web—even if they do not say "PRD".
license: Apache-2.0
---
...
If a project tracker is available (optional):
...
If internal docs are available:
...
If Figma or design files are available:
