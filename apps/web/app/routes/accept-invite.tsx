  ...
  return (
    <form className="login-form-fields" onSubmit={handleSubmit(onSubmit)}>
      <div className="login-field-group space-y-1.5" style={{ '--field-i': 0 } as CSSProperties}>
        <label className={authLabelClassName} htmlFor="accept-password">
          设置密码
        </label>
        <PasswordInput
          id="accept-password"
      ...
      <div className="login-field-group space-y-1.5" style={{ '--field-i': 1 } as CSSProperties}>
        <label className={authLabelClassName} htmlFor="accept-confirm">
          确认密码
        </label>
        <PasswordInput
          id="accept-confirm"
  ...
  return (
    <div className="login-form-fields space-y-4">
      <p className={authBodyTextClassName}>
        接受邀请需配置 <code className="text-brand dark:text-brand-light">VITE_API_URL</code> 并启动 SaaS API。
      </p>
