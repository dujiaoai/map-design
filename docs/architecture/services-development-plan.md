...
**Sprint D 进度**：**D-01 ✅** … **D-06 ✅** 租户成员 admin API；**D-07 ✅** apps/admin 脚手架；D-08～D-10 待做。**暂不启动**地图/机库等业务 API。
...
| **RBAC / 权限配置 / 后台管理**       | D-01～D-07 ✅；D-08～D-10：Admin CRUD 页、部署 | P2  |
...
| D-08～D-10 | D | 前端：Admin CRUD 页、权限门控、Docker 部署 |
