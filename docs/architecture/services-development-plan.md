...
**Sprint D 进度**：**D-01 ✅** 权限表；**D-02 ✅** JWT permissions；**D-03 ✅** 角色权限配置；**D-04 ✅** 租户 admin API；D-05～D-10 待做。**暂不启动**地图/机库等业务 API。
...
| **RBAC / 权限配置 / 后台管理**       | D-01～D-04 ✅；D-05～D-10：用户/成员 admin、apps/admin | P2  |
...
| D-05～D-06 | D | 后端：用户/成员 admin API |
