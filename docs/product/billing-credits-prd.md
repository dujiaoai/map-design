...
| sec | 安全与稳定性加固（Webhook/Caller/RFC7807/Job/CDC push·HMAC/Admin 分页/冒烟 24 步 mock） | ✅ 2026-06-14 |
...
| f-sec-hardening | Webhook 验签/限流、Internal Caller、RFC7807、Micrometer、Admin ledger/分页、membership push·HMAC、signup/refund/订单过期 Job、`SuspendedTenantBillingPolicyTest`、冒烟 24 步（mock） ✅（2026-06-14）；详见 [billing-service.md](../architecture/billing-service.md) §Sprint F 安全与稳定性改进 |
