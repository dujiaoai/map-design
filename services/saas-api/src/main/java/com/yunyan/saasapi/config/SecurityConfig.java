  ...
  SecurityFilterChain securityFilterChain(
    ...
    return http
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers(HttpMethod.GET, "/v1/auth/invite-links/preview", "/v1/auth/oidc/providers", "/v1/auth/oidc/*/authorize", "/v1/auth/tenants/*/sso").permitAll()
            .requestMatchers(HttpMethod.POST, "/v1/auth/oidc/*/callback").permitAll()
