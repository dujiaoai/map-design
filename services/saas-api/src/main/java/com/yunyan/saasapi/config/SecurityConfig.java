  ...
  SecurityFilterChain securityFilterChain(
    ...
    return http
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers(HttpMethod.POST, "/v1/auth/login", "/v1/auth/register", "/v1/auth/register/confirm", "/v1/auth/register/resend", "/v1/auth/refresh", "/v1/auth/accept-invite", "/v1/auth/password-reset/request", "/v1/auth/password-reset/confirm")
                .permitAll()
