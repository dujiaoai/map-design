  ...
  SecurityFilterChain securityFilterChain(
    ...
    return http
        ...
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers(HttpMethod.GET, "/v1/auth/invite-links/preview", "/v1/auth/oidc/providers", "/v1/auth/oidc/*/authorize", "/v1/auth/tenants/*/sso", "/v1/auth/tenants/*/sso/authorize", "/v1/auth/tenant-sso/saml/*/authorize").permitAll()
            .requestMatchers(HttpMethod.POST, "/v1/auth/oidc/*/callback", "/v1/auth/tenants/*/sso/callback", "/v1/auth/tenant-sso/saml/*/acs").permitAll()
