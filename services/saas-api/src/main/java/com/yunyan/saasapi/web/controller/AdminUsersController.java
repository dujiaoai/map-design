...
public class AdminUsersController {
  ...
  @Operation(
      summary = "列出用户",
      description = "可选 tenantId、status 过滤；q/page/size/sortBy/sortDir 分页搜索与排序（无分页参数时返回全量）")
  public AdminUserListResponse listUsers(
    ...
    return userAdminService.listUsers(
        Optional.ofNullable(tenantId), new AdminListParams(q, page, size, status, sortBy, sortDir));
  }
