...
public record AdminStatsResponse(
    ...
    @Schema(description = "已停用租户数") long suspendedTenantCount,
    @Schema(description = "试用中租户数") long trialActiveTenantCount,
    @Schema(description = "试用已到期租户数") long trialExpiredTenantCount) {}
