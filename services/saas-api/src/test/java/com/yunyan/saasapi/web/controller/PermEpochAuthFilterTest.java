...
import com.yunyan.saasapi.security.PermEpochStaleException;
...
@ActiveProfiles("test")
@TestPropertySource(properties = "saas.jwt.perm-epoch=2")
class PermEpochAuthFilterTest {
  ...
  void stalePermEpoch_returns403ProblemDetail() throws Exception {
    ...
    var token = staleAccessToken(userId, tenantId, List.of(PermissionCodes.WORKSPACE_USE));
